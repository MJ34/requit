...
import com.pk.recruiter.service.ApplicationService;
import com.pk.recruiter.service.JobSeekerService;
import com.pk.recruiter.service.JobService;
import com.pk.recruiter.service.UsersService;
...
public class HomeController {
	...
	@RequestMapping(value = "dashboardUser", method = { RequestMethod.POST, RequestMethod.GET })
	public ModelAndView processLogin(HttpServletRequest req, @ModelAttribute Users theJobSeekerUser) {
		...
		if (loginUsers == null) {
			...
			// both are correct
			//System.out.println("userRole " + loginUsers.getRole());
