...
import com.pk.recruiter.service.JobService;
import com.pk.recruiter.service.LoginUsersService;
...
public class JobSeekerController {
	...
	public String dbInitial(ModelMap model) throws ParseException {
		...
		educationCategoryList.add(new EducationCategory("SMP"));
		educationCategoryList.add(new EducationCategory("SMA / SMK"));
		educationCategoryList.add(new EducationCategory("Diploma"));
		educationCategoryList.add(new EducationCategory("Sarjana"));
