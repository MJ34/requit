...
import com.pk.recruiter.service.CertificationsService;
...
public class CertificationsController {
	...
	public ModelAndView deleteCertification(HttpServletRequest request,@RequestParam("certificationId") Integer Id)
	{
		JobSeeker activeUser = (JobSeeker) request.getSession().getAttribute("userId");
		ModelAndView model = null;
