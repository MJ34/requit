	...
	<div class="row">
			<div class="col-lg-2">
				...
				<div class="container card-body">
					...
					<div class="row ">
						<a href="organization" class="btn btn-block btn-outline-primary"
							>Organization</a>
					</div><br>
					<div class="row ">
						<a href="workExp" class="btn btn-block btn-outline-primary"
							>Work Experience</a>
					</div><br>
					<div class="row ">
					...
					<div class="row ">
						<a href="family" class="btn btn-block btn-outline-primary"
							 id="family_id">Family</a>
					</div><br>
					<div class="row ">
