...
<head>
<title>Home |  PT. PUNGKOOK INDONESIA ONE</title>
<meta charset="UTF-8">
...
<body>
		...
		<nav class="navbar navbar-expand-lg">
			<div class="container">
				<a class="navbar-brand text-white" href="/"><i
					class="fa fa-graduation-cap fa-lg mr-2"></i> PT. PUNKOOK INDONESIA ONE</a>
	...
	<header class="sticky-top">
		...
		<nav class="navbar navbar-expand-lg">
			<div class="container">
				<a class="navbar-brand text-white" href="/"><i class="fa fa-suitcase" aria-hidden="true"></i> PT. PUNKOOK INDONESIA ONE</a>
				<button class="navbar-toggler" type="button" data-toggle="collapse"
					data-target="#nvbCollapse" aria-controls="nvbCollapse">
