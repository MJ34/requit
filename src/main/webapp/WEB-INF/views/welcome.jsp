...
<head>
<title>PT. PUNGKOOK INDONESIA ONE</title>
</head>
			...
			<div class="detail">
				<div class="media display-inline text-align-center">
					<img class="mr-3" style="width: 75px; height: 75px;"
						alt="company_logo"
						src="http://183.81.158.230/recruit/static/assets/img/icon/PK_logo.png">
					<div class="media-body text-left  text-align-center">
						<h6 class="large material-icon ">
							${tempjoblist.company} looking for ${tempjoblist.jobName}</h6>
						<i class="font-color-black">${tempjoblist.jobType}:</i> <span
						...
						<c:choose>
							<c:when test="${tempjoblist.applicaionsList.isEmpty()}">
								<div class="float-right margin-top text-align-center">
									...
									<p class="date-time">Deadline: ${tempjoblist.expiredDate}</p>
